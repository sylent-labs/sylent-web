                ...
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="mt-12 max-w-2xl sm:mt-16">
                        ...
                        <p className="mt-3 text-sm text-white/70 sm:mt-4 sm:text-base">
                            A global engineering company that helps businesses
                            build, ship and scale reliable digital systems.
                        </p>

                        <p className="mt-2 text-xs leading-relaxed text-white/40 sm:text-sm">
                            Mobile &amp; web development, UI/UX design, backend
                            systems, databases, cloud infrastructure, API
                            integrations, AI solutions, DevOps, project
                            management and more.
                        </p>

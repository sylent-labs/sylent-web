            ...
            >
                ...
                <div id="team">
                    ...
                    >
                        ...
                        shipping production systems across industries and
                        continents.
                    </p>
                ...
                <div id="mission">
                    ...
                    <h2
                        ...
                        className="text-2xl font-semibold leading-tight tracking-tight text-white sm:text-3xl md:text-5xl"
                    >
                        To help businesses build and scale reliable digital
                        systems through focused engineering, thoughtful design
                    ...
                    <div className="mt-10 space-y-8 sm:mt-14 md:mt-16">
                        ...
                        >
                            We exist to deliver real solutions, not
                            presentations and not promises. We work on systems
                        ...
                        <p
                            ...
                            className="text-sm leading-relaxed text-white/65 sm:text-base md:text-lg"
                        >
                            As a California based company powered by global
                            engineering talent, we combine startup agility with
                            the resources of a large enterprise. Offering the
                            technical depth of a large firm while maintaining
                            the direct access and accountability of a small
                            team.
                        </p>
                        ...
                        <p
                            ...
                            className="text-sm leading-relaxed text-white/65 sm:text-base md:text-lg"
                        >
                            We build mobile apps, web platforms, backend
                            systems, integrations, AI tools and enterprise grade
                            solutions with one goal: to simplify operations,
                            reduce friction, and turn complex processes into
                            reliable systems.
                        </p>
                    </div>
                ...
                <div id="vision">
                    ...
                    <h2
                        ...
                        className="text-2xl font-semibold leading-tight tracking-tight text-white sm:text-3xl md:text-5xl"
                    >
                        To become the trusted technology partner for growing
                        businesses that value execution over noise.
                    </h2>
                    ...
                    <div className="mt-10 space-y-8 sm:mt-14 md:mt-16">
                        <p
                            ...
                            className="text-sm leading-relaxed text-white/65 sm:text-base md:text-lg"
                        >
                            We envision a future where companies choose partners
                            not by size or hype, but by reliability, clarity and
                            consistent delivery.
                        </p>
                        ...
                        <p
                            ...
                            className="text-sm leading-relaxed text-white/65 sm:text-base md:text-lg"
                        >
                            Sylent aims to prove that a focused team with strong
                            engineering discipline and clear communication can
                            deliver better results than larger firms burdened by
                        ...
                        <p
                            ...
                            className="text-sm leading-relaxed text-white/65 sm:text-base md:text-lg"
                        >
                            We strive to offer the capabilities of a large
                            technology company while preserving the
                            responsiveness, transparency and personal
